...
The current version focuses on project, execution-configuration, POU, and variable inspection and shallow project validation, plus compilation delegated to `openplc-cli`. Project modification, variable modification, deployment, runtime control, variable forcing, authentication, HTTP transport, and generic shell/filesystem tools are not implemented.
