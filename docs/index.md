...
Load for the current eleven MCP tools, inputs, outputs, annotations, errors, and diagnostics behavior.
...
| File | Responsibility |
| --- | --- |
| `src/openplc_engineering_mcp/server.py` | MCP server creation, eleven tool registrations, annotations, and stdio entry point |
