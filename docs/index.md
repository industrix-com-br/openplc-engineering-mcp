...
| Change execution configuration inspection | [`openplc-projects.md`](openplc-projects.md), [`tools.md`](tools.md) | `src/openplc_engineering_mcp/openplc/execution.py`, `tests/test_execution.py` |
| Change physical I/O configuration inspection | [`openplc-projects.md`](openplc-projects.md), [`tools.md`](tools.md) | `src/openplc_engineering_mcp/openplc/io.py`, `tests/test_io.py` |
| Change POU discovery, access, or update | [`openplc-projects.md`](openplc-projects.md), [`tools.md`](tools.md) | `src/openplc_engineering_mcp/openplc/pous.py`, `tests/test_pous.py` |
...
| Change project data-type inspection | [`openplc-projects.md`](openplc-projects.md), [`tools.md`](tools.md) | `src/openplc_engineering_mcp/openplc/datatypes.py`, `tests/test_datatypes.py` |
...
| `src/openplc_engineering_mcp/openplc/pous.py` | POU discovery, reading, and Structured Text updating, language mapping, containment checks, and name deduplication |
...
| `tests/test_pous.py` | POU discovery, reading, and update behavior tests |
